...
namespace BootstrapSupport.HtmlHelpers {
	...
	public static class PaginiationHelperExtensions {
		...
		/// </param>
		/// <param name="additionalPagerCssClass">
		///     Additional classes for the navigation div (e.g. "pagination-right
		///     pagination-mini")
		/// </param>
		/// <returns></returns>
	...
	public class PagedList<T> : List<T>,
		...
		public PagedList(IEnumerable<T> source,
		                 int pageIndex,
		                 int pageSize) : this(source.GetPage(pageIndex,
		                                                     pageSize),
		                                      pageIndex,
		                                      pageSize,
		                                      source.Count()) {}
	...
	public static class PagingExtensions {
		public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> query,
		                                           int page,
		                                           int pageSize) {
		...
		public static IEnumerable<T> GetPage<T>(this IEnumerable<T> source,
		                                        int pageIndex,
		                                        int pageSize) {
